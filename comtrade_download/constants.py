...
PERIODS = tuple(str(year) for year in range(PERIOD_START_YEAR, PERIOD_END_YEAR + 1))
...
OUTPUT_FILENAME = f"TradeData_sitc4_ag3_{PERIOD_START_YEAR}_{PERIOD_END_YEAR}.csv"
